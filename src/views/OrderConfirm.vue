        ...
        <div class="checkout-order">
                ...
                <li>
                  <div class="cart-tab-1">
                    <div class="cart-item-pic">
                      <img src="../../static/1.jpg" alt="itemproductName">
                    </div>
                  ...
                  <div class="cart-tab-2">
                    <div class="item-price">99999</div>
                  </div>
                  <div class="cart-tab-3">
                    <div class="item-quantity">
                      <div class="select-self">
                        <div class="select-self-area">
                          <span class="select-ipt">99999</span>
                        </div>
                      </div>
                  ...
                  <div class="cart-tab-4">
                    <div class="item-price-total">99999</div>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div class="order-foot-wrap">
            <div class="prev-btn-wrap">
              <router-link class="btn btn--m--order" to="/address">Previous</router-link>
            </div>
            <div class="next-btn-wrap">
              <button class="btn btn--m--order btn--red">Proceed to payment</button>
            </div>
          </div>
        </div>
      </div>
